      ...
      <section className="border-b border-rule bg-paper-sunk/30">
        <div className="mx-auto max-w-[1440px] px-6 pb-14 pt-36 sm:pt-40">
          <div className="flex flex-col gap-4 w-full">
            ...
            <p className="m-0 text-ink-600 font-light text-[1.0625rem] sm:text-[1.125rem] leading-relaxed max-w-[56ch]">
          ...
          <div className="mt-12 flex flex-wrap items-center gap-2.5 pt-6 border-t border-rule/70">
